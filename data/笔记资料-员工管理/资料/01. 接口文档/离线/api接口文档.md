...
```shell
/students?name=张三&isCollege=1&degree=1&clazzId=2&page=1&pageSize=5
```
...
| msg          | string   | 非必须   | 提示信息                       |
| data         | object   | 非必须   | 返回的数据                     |
| \|- yearList | string[] | 必须     | 年份列表                       |
| \|- dataList | number[] | 必须     | 每一年的入职员工人数列表       |
